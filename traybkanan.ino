void goto_kakikananbkanan() {
  float tmp_pos[3];
  for (int i = 0; i < 21; i++ ) {
    tmp_pos[0] = posxbkanan[i];
    tmp_pos[1] = posybkanan[i];
    tmp_pos[2] = poszbkanan[i];

    IK_Kanan1(tmp_pos);
    //IK_Kanan2(tmp_pos);
    pos_degcoxabkanan[i] = angle_kanan[0];
    pos_degfemurbkanan[i] = angle_kanan[1];
    pos_degtibiabkanan[i] = angle_kanan[2];
...
void goto_kakikananbkanan_2() {
  float tmp_pos[3];
  for (int i = 0; i < 21; i++ ) {
    tmp_pos[0] = posxbkanan_2[i];
    tmp_pos[1] = posybkanan_2[i];
    tmp_pos[2] = poszbkanan_2[i];

    IK_Kanan1(tmp_pos);
    //IK_Kanan2(tmp_pos);
    pos_degcoxabkanan_2[i] = angle_kanan[0];
    pos_degfemurbkanan_2[i] = angle_kanan[1];
    pos_degtibiabkanan_2[i] = angle_kanan[2];
...
void goto_servo_kananbkanan(float servo_c, float servo_f, float servo_t) {
...
void goto_kakikiribkanan() {
  float tmp_pos[3];
  for (int i = 0; i < 21; i++ ) {
    tmp_pos[0] = posxkiribkanan[i];
    tmp_pos[1] = posykiribkanan[i];
    tmp_pos[2] = poszkiribkanan[i];

    IK_Kiri1(tmp_pos);
    //IK_Kanan2(tmp_pos);
    pos_degcoxakiribkanan[i] = angle_kiri[0];
    pos_degfemurkiribkanan[i] = angle_kiri[1];
    pos_degtibiakiribkanan[i] = angle_kiri[2];
...
void goto_kakikiribkanan_2() {
  float tmp_pos[3];
  for (int i = 0; i < 21; i++ ) {
    tmp_pos[0] = posxkiribkanan_2[i];
    tmp_pos[1] = posykiribkanan_2[i];
    tmp_pos[2] = poszkiribkanan_2[i];

    IK_Kiri1(tmp_pos);
    //IK_Kanan2(tmp_pos);
    pos_degcoxakiribkanan_2[i] = angle_kiri[0];
    pos_degfemurkiribkanan_2[i] = angle_kiri[1];
    pos_degtibiakiribkanan_2[i] = angle_kiri[2];
...
void goto_servo_kiribkanan(float servo_c, float servo_f, float servo_t) {
