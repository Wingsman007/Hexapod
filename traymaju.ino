void goto_kakikananmaju() {
  float tmp_pos[3];
  for (int i = 0; i < 21; i++ ) {
    tmp_pos[0] = posxmaju[i];
    tmp_pos[1] = posymaju[i];
    tmp_pos[2] = poszmaju[i];

    IK_Kanan1(tmp_pos);
    //IK_Kanan2(tmp_pos);
    pos_degcoxamaju[i] = angle_kanan[0];
    pos_degfemurmaju[i] = angle_kanan[1];
    pos_degtibiamaju[i] = angle_kanan[2];
...
void goto_kakikananmaju_2() {
  float tmp_pos[3];
  for (int i = 0; i < 21; i++ ) {
    tmp_pos[0] = posxmaju_2[i];
    tmp_pos[1] = posymaju_2[i];
    tmp_pos[2] = poszmaju_2[i];

    IK_Kanan1(tmp_pos);
    //IK_Kanan2(tmp_pos);
    pos_degcoxamaju_2[i] = angle_kanan[0];
    pos_degfemurmaju_2[i] = angle_kanan[1];
    pos_degtibiamaju_2[i] = angle_kanan[2];
...
void goto_servo_kananmaju(float servo_c, float servo_f, float servo_t) {
...
void goto_kakikirimaju() {
  ...
  for (int i = 0; i < 21; i++ ) {
    ...
    IK_Kiri1(tmp_pos);
    //IK_Kanan2(tmp_pos);
    pos_degcoxamaju[i] = angle_kiri[0];
    pos_degfemurmaju[i] = angle_kiri[1];
    pos_degtibiamaju[i] = angle_kiri[2];
...
void goto_kakikirimaju_2() {
  ...
  for (int i = 0; i < 21; i++ ) {
    ...
    IK_Kiri1(tmp_pos);
    //IK_Kanan2(tmp_pos);
    pos_degcoxamaju_2[i] = angle_kiri[0];
    pos_degfemurmaju_2[i] = angle_kiri[1];
    pos_degtibiamaju_2[i] = angle_kiri[2];
...
void goto_servo_kirimaju(float servo_c, float servo_f, float servo_t) {
